...
Feature_target = Feature[['RH','T2M','U10','V10','PV','member_median_neg_1']]
...
filtered_irradiance1  = low_pass_filter_fft(feature1.member_median_neg_1.values,1)
filtered_irradiance2  = low_pass_filter_fft(feature2.member_median_neg_1.values,2)
filtered_irradiance3  = low_pass_filter_fft(feature3.member_median_neg_1.values,2)
filtered_irradiance4  = low_pass_filter_fft(feature4.member_median_neg_1.values,2)
filtered_irradiance5  = low_pass_filter_fft(feature5.member_median_neg_1.values,2)
filtered_irradiance6  = low_pass_filter_fft(feature6.member_median_neg_1.values,2)  
filtered_irradiance7  = low_pass_filter_fft(feature7.member_median_neg_1.values,2)  
filtered_irradiance8  = low_pass_filter_fft(feature8.member_median_neg_1.values,2)
filtered_irradiance9  = low_pass_filter_fft(feature9.member_median_neg_1.values,2)
filtered_irradiance10 = low_pass_filter_fft(feature10.member_median_neg_1.values,2)
filtered_irradiance11 = low_pass_filter_fft(feature11.member_median_neg_1.values,2)
filtered_irradiance12 = low_pass_filter_fft(feature12.member_median_neg_1.values,2)
filtered_irradiance13 = low_pass_filter_fft(feature13.member_median_neg_1.values,2)
...
feature1.insert(3,"normirradiance",feature1.member_median_neg_1/feature1.FFT_SSRD)
# model 2: 15:00:00
...
feature2.insert(3,"normirradiance",feature2.member_median_neg_1/feature2.FFT_SSRD)
# model 3: 16:00:00
...
feature3.insert(3,"normirradiance",feature3.member_median_neg_1/feature3.FFT_SSRD)
# model 4: 17:00:00
...
feature4.insert(3,"normirradiance",feature4.member_median_neg_1/feature4.FFT_SSRD)
# model 5: 18:00:00
...
feature5.insert(3,"normirradiance",feature5.member_median_neg_1/feature5.FFT_SSRD)
# model 6: 19:00:00
...
feature6.insert(3,"normirradiance",feature6.member_median_neg_1/feature6.FFT_SSRD)
# model 7: 20:00:00
...
feature7.insert(3,"normirradiance",feature7.member_median_neg_1/feature7.FFT_SSRD)
# model 8: 21:00:00
...
feature8.insert(3,"normirradiance",feature8.member_median_neg_1/feature8.FFT_SSRD)
# model 9: 22:00:00
...
feature9.insert(3,"normirradiance",feature9.member_median_neg_1/feature9.FFT_SSRD)
# model 10: 23:00:00
...
feature10.insert(3,"normirradiance",feature10.member_median_neg_1/feature10.FFT_SSRD)
# model 11: 00:00:00
...
feature11.insert(3,"normirradiance",feature11.member_median_neg_1/feature11.FFT_SSRD)
# model 12: 01:00:00
...
feature12.insert(3,"normirradiance",feature12.member_median_neg_1/feature12.FFT_SSRD)
# model 13: 02:00:00
...
feature13.insert(3,"normirradiance",feature13.member_median_neg_1/feature13.FFT_SSRD)
...
new_time = pd.date_range(start='2020-01-01 00:00:00', end='2020-12-31 23:00:00', freq='1h', tz='UTC')
new_results = pd.DataFrame(columns=['PV_AC'], index=new_time)
new_results['PV_AC'] = Results_GBM_sort['predict_power']




Results_GBM = Results_GBM.replace(0,np.nan)
Results_GBM = Results_GBM.dropna()
...
mape = mape(Results_GBM.real_PV, Results_GBM.predict_power)
...
mre = re(Results_GBM.real_PV, Results_GBM.predict_power)
...
rmspe = rmspe(Results_GBM.real_PV, Results_GBM.predict_power)
